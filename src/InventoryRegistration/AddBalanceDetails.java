 ...
 * @author Piyumi
 */
public class AddBalanceDetails extends javax.swing.JFrame {

    /** Creates new form AddBalanceDetails */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Inventory Details");
        ...
        jLabel4.setText("Book Balance");

        jLabel5.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel5.setText("Physical Balance");
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/IMG-20191208-WA0012.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jComboBox1.getSelectedItem().toString().equals("Select Hostel Name")){
           ...
           JOptionPane.showMessageDialog(rootPane,"Enter Item Type" );
        }   
        else if(jTextField1.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(rootPane,"Enter Book Balance" );
        }
        else if(jTextField2.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(rootPane,"Enter Physical Balance" );
        }
        ...
        int bBalance = Integer.parseInt(jTextField1.getText());
        int pBalance = Integer.parseInt(jTextField2.getText());
        ...
        try {
            ...
            if(itemtype==itemtype && hostelname==hostelname){
                String query3 ="SELECT * FROM totalinventory ";
                ResultSet rs = stmt.executeQuery(query3);
                
                 if(rs.next()){
                      
                  String query4 = "UPDATE totalinventory SET bookbalance = '"+bBalance+"',physicalbalance = '"+pBalance+"' WHERE itemtype = '"+itemtype+"' and place = '"+hostelname+"'";
                  int n=0;
                  n=stmt.executeUpdate(query4);
                 
                  
             JOptionPane.showMessageDialog(rootPane, "Inventory Balance Details Added Successfully");                                            
                 
                }            
            }else{
              JOptionPane.showMessageDialog(rootPane, "Error while Inserting"); 
             } 
   ...
   //     jPanellogouteditprofile.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBalanceDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
