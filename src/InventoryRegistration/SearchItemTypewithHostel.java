 ...
 * @author Piyumi
 */
public class SearchItemTypewithHostel extends javax.swing.JFrame {

    /**
     * Creates new form ChairRegistration
     */
    public SearchItemTypewithHostel() {
        initComponents();
   ...
   DefaultTableModel model;
    ...
    public void addTableHeader(){
        ...
        Object[] newIdetifiers=new Object[]{"Hostel Name","Item Type","Item ID","Remark","Last Updated Date"};
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/IMG-20191208-WA0013.jpg"))); // NOI18N
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Item Type", "Hostel Chair", "Staff Chair", "Reading Chair", "Dinning Chair", "Canteen Chair", "Hostel Table", "Staff Table", "Reading Table", "Dinning Table", "Exam Table", "Student Bed", "Staff Bed", "News Paper Holder", "Towel Rack", "Almari", "Hostel Cupboard", "Dressing Table", "Dressing Table Stool" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         ...
         if(jComboBox1.getSelectedItem().toString().equals("Select Hostel Name")){
            JOptionPane.showMessageDialog(rootPane,"Select Hostel Name" );
        }
         else if(jComboBox2.getSelectedItem().toString().equals("Select Item Type")){
            JOptionPane.showMessageDialog(rootPane,"Select Item Type" );
        }
         
         else{
        model.addRow(new Object[]{"Hostel Name","Item Type","Item ID","Remark","Last Updated Date"});

        String hostelname = jComboBox1.getSelectedItem().toString();
        String itemtype = jComboBox2.getSelectedItem().toString();
        try{

            connectiondb c = new connectiondb();
            Statement stmt = c.getConnectiondb().createStatement();

            if(itemtype=="Staff Bed" ){
                String query1 = "SELECT * FROM staffbed WHERE place = '"+hostelname+"'  ";
                ...
                while(rs.next()){
                    ...
                    model.addRow(new Object[]{hostelname,itemtype,itemid,remark,lastupdateddate});
                }
            }
            //
            else if(itemtype=="Student Bed" ){
                String query1 = "SELECT * FROM studentbed WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Hostel Chair" ){
                String query1 = "SELECT * FROM hostelchair WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Staff Chair" ){
                String query1 = "SELECT * FROM staffchair WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Reading Chair" ){
                String query1 = "SELECT * FROM readingchair WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Dinning Chair" ){
                String query1 = "SELECT * FROM dinningchair WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Canteen Chair" ){
                String query1 = "SELECT * FROM canteenchair WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Hostel Table" ){
                String query1 = "SELECT * FROM hosteltable WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Staff Table" ){
                String query1 = "SELECT * FROM stafftable WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Reading Table" ){
                String query1 = "SELECT * FROM readingtable WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Dinning Table" ){
                String query1 = "SELECT * FROM dinningtable WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Exam Table" ){
                String query1 = "SELECT * FROM examtable WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            if(itemtype=="News Paper Holder" ){
                String query1 = "SELECT * FROM newspaperholder WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Towel Rack" ){
                String query1 = "SELECT * FROM towelrack WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Almari" ){
                String query1 = "SELECT * FROM almari WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Hostel Cupboard" ){
                String query1 = "SELECT * FROM hostelcupboard WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Dressing Table" ){
                String query1 = "SELECT * FROM dressingtable WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            else if(itemtype=="Dressing Table Stool" ){
                String query1 = "SELECT * FROM dressingtablestool WHERE place = '"+hostelname+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
...
private void HostelNameCombo(){
        ...
        private void ItemTypeCombo(){
         
        String itemtype = jComboBox2.getSelectedItem().toString();
          try{
            connectiondb c=new connectiondb();
            Statement stmt=c.getConnectiondb().createStatement();
            String selectQuery="select itemtype from totalinventory";
            ResultSet rs=stmt.executeQuery(selectQuery);
            while(rs.next())
            {
                String itemType=rs.getString("itemtype");
                jComboBox2.addItem(itemType);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchItemTypewithHostel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchItemTypewithHostel().setVisible(true);
            }
        });
    }
