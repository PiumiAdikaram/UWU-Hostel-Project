 ...
 * @author Piyumi
 */
public class SelectSearch extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/FB_IMG_1465264522792.jpg"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Cambria", 1, 22)); // NOI18N
        jLabel1.setText("Hostel Search");
...
/*        Login l = new Login();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectSearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
