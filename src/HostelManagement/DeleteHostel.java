 ...
 * @author Piyumi
 */
public class DeleteHostel extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String query3 = "DELETE FROM hostel WHERE hostelname = '"+hostelname+"' ";
            int n = stmt.executeUpdate(query3);
            if (n!=0) {
                JOptionPane.showMessageDialog(rootPane, "Delete Hostel details Successfully.");
            }
            else {
                JOptionPane.showMessageDialog(rootPane, "Error while deleting the hostel details.");
            }
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteHostel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
