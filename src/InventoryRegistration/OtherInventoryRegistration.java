 ...
 * @author Piyumi
 */
public class OtherInventoryRegistration extends javax.swing.JFrame {

    /**
     * Creates new form ChairRegistration
     */
    public OtherInventoryRegistration() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/other6.jpg"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Cambria Math", 1, 22)); // NOI18N
        jLabel1.setText("Other Item Inventory Form");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(20, 20, 20)
                .addComponent(jLabel11, javax.swing.GroupLayout.PREFERRED_SIZE, 290, Short.MAX_VALUE)
                .addGap(20, 20, 20))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextArea1.getText().trim().isEmpty()){
         ...
         else if(jComboBox1.getSelectedItem().toString().equals("Select Item Type")){
        ...
        try {
            ...
            //
           if(itemType=="News Paper Holder"){
                 String selectQuery="select itemid from newspaperholder where itemid='"+itemId+"' ";
            ResultSet rs5=stmt.executeQuery(selectQuery);
            if(rs5.next())
            {
                   JOptionPane.showMessageDialog(rootPane,"This item is already existed" );
            }else{
                String query2 ="INSERT INTO newspaperholder (itemid,place,inventorypageno,remark,lastupdateddate)VALUES('"+itemId+"','"+place+"','"+pageNo+"','"+remark+"','"+date+"')";
           ...
           n=stmt.executeUpdate(query2);
            ...
            if(n!=0){
                ...
                if(rs.next()){
                    ...
                    if(n2!=0){
                        JOptionPane.showMessageDialog(rootPane, "News Paper Holder Registered Successfully !!!");
                    }else{
                        JOptionPane.showMessageDialog(rootPane, "Error while News Paper Holder Registration");     
                    }        
                }
            }else{
            ...
            //
            if(itemType=="Towel Rack"){
                  String selectQuery="select itemid from towelrack where itemid='"+itemId+"' ";
            ResultSet rs5=stmt.executeQuery(selectQuery);
            if(rs5.next())
            {
                   JOptionPane.showMessageDialog(rootPane,"This item is already existed" );
            }else{
                String query2 ="INSERT INTO towelrack (itemid,place,inventorypageno,remark,lastupdateddate)VALUES('"+itemId+"','"+place+"','"+pageNo+"','"+remark+"','"+date+"')";
           ...
           n=stmt.executeUpdate(query2);
            ...
            if(n!=0){
                ...
                if(rs.next()){
                    ...
                    if(n2!=0){
                        JOptionPane.showMessageDialog(rootPane, "Towel Rack Registered Successfully !!!");
                    }else{
                        JOptionPane.showMessageDialog(rootPane, "Error while Towel Rack Registration");     
                    }        
                }
            }else{
                JOptionPane.showMessageDialog(rootPane, "Error while Updating");     
            ...
            //
            if(itemType=="Almari"){
                  String selectQuery="select itemid from almari where itemid='"+itemId+"' ";
            ResultSet rs5=stmt.executeQuery(selectQuery);
            if(rs5.next())
            {
                   JOptionPane.showMessageDialog(rootPane,"This item is already existed" );
            }else{
                String query2 ="INSERT INTO almari (itemid,place,inventorypageno,remark,lastupdateddate)VALUES('"+itemId+"','"+place+"','"+pageNo+"','"+remark+"','"+date+"')";
           ...
           n=stmt.executeUpdate(query2);
            ...
            if(n!=0){
                ...
                if(rs.next()){
                    ...
                    if(n2!=0){
                        JOptionPane.showMessageDialog(rootPane, "Almari Registered Successfully !!!");
                    }else{
                        JOptionPane.showMessageDialog(rootPane, "Error while Almari Registration");     
                    }        
                }
            }else{
                JOptionPane.showMessageDialog(rootPane, "Error while Updating");     
            ...
            if(itemType=="Hostel Cupboard"){
                  String selectQuery="select itemid from hostelcupboard where itemid='"+itemId+"' ";
            ResultSet rs5=stmt.executeQuery(selectQuery);
            if(rs5.next())
            {
                   JOptionPane.showMessageDialog(rootPane,"This item is already existed" );
            }else{
                String query2 ="INSERT INTO hostelcupboard (itemid,place,inventorypageno,remark,lastupdateddate)VALUES('"+itemId+"','"+place+"','"+pageNo+"','"+remark+"','"+date+"')";
           ...
           n=stmt.executeUpdate(query2);
            ...
            if(n!=0){
                ...
                if(rs.next()){
                    ...
                    if(n2!=0){
                        JOptionPane.showMessageDialog(rootPane, "Hostel Cupboard Registered Successfully !!!");
                    }else{
                        JOptionPane.showMessageDialog(rootPane, "Error while Hostel Cupboard Registration");     
                    }        
                }
            }else{
                JOptionPane.showMessageDialog(rootPane, "Error while Updating");     
            ...
            if(itemType=="Dressing Table"){
            String selectQuery="select itemid from dressingtable where itemid='"+itemId+"' ";
            ResultSet rs5=stmt.executeQuery(selectQuery);
            if(rs5.next())
            {
                   JOptionPane.showMessageDialog(rootPane,"This item is already existed" );
            }else{
                String query2 ="INSERT INTO dressingtable (itemid,place,inventorypageno,remark,lastupdateddate)VALUES('"+itemId+"','"+place+"','"+pageNo+"','"+remark+"','"+date+"')";
           ...
           n=stmt.executeUpdate(query2);
            ...
            if(n!=0){
                ...
                if(rs.next()){
                    ...
                    if(n2!=0){
                        JOptionPane.showMessageDialog(rootPane, "Dressing Table Registered Successfully !!!");
                    }else{
                        JOptionPane.showMessageDialog(rootPane, "Error while Dressing Table Registration");     
                    }        
                }
            }else{
                JOptionPane.showMessageDialog(rootPane, "Error while Updating");     
             ...
             if(itemType=="Dressing Table Stool"){
                 
                   String selectQuery="select itemid from dressingtablestool where itemid='"+itemId+"' ";
            ResultSet rs5=stmt.executeQuery(selectQuery);
            if(rs5.next())
            {
                   JOptionPane.showMessageDialog(rootPane,"This item is already existed" );
            }else{
                String query2 ="INSERT INTO dressingtablestool (itemid,place,inventorypageno,remark,lastupdateddate)VALUES('"+itemId+"','"+place+"','"+pageNo+"','"+remark+"','"+date+"')";
           ...
           n=stmt.executeUpdate(query2);
            ...
            if(n!=0){
                ...
                if(rs.next()){
                    ...
                    if(n2!=0){
                        JOptionPane.showMessageDialog(rootPane, "Dressing Table Stool Registered Successfully !!!");
                    }else{
                        JOptionPane.showMessageDialog(rootPane, "Error while Dressing Table Stool Registration");     
                    }        
                }
            }else{
                JOptionPane.showMessageDialog(rootPane, "Error while Updating");     
  ...
  //      jPanellogouteditprofile.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OtherInventoryRegistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
