 ...
 * @author Piyumi
 */
public class newplaceregistration extends javax.swing.JFrame {

    /**
     * Creates new form newplaceregistration
     */
    public newplaceregistration() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("New Place Registration ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String placename = jTextField1.getText();
      String address = jTextArea1.getText();
        
      if(jTextField1.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(rootPane,"Enter Place Name" );
        }
        else if(jTextArea1.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(rootPane,"Enter New Place Address" );
        }
        ...
        try {
            ...
            String query1 = "INSERT INTO newplace (placename, address) VALUES ('"+placename+"','"+address+"')";
            
           int n=0;
           n=stmt.executeUpdate(query1);
          
            if(n!=0){
                JOptionPane.showMessageDialog(rootPane, "New Place Registered Successfully !!!");
            }else{
                JOptionPane.showMessageDialog(rootPane, "Error while New Place Registration");     
            } 
    ...
    private void jTextField1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyTyped
        ...
        if(!match.matches()){
        jLabel4.setText("Please use letters only");
        }else{
    ...
    private void jTextField2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyTyped
        ...
        if(!match.matches()){
        jLabel5.setText("Please use letters, numbers and comma only");
        }else{
...
/*        Login l = new Login();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newplaceregistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
