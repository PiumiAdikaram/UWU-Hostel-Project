 ...
 * @author Piyumi
 */
public class InventoryTransferTable extends javax.swing.JFrame {

    /**
     * Creates new form InventoryTranfer
     */
    public InventoryTransferTable() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Add New Place");
        ...
        jLabel1.setText("Table Transfer Form ");

        jLabel17.setForeground(new java.awt.Color(255, 0, 0));

        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/table6.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Validation Is Empty
        if(jComboBox1.getSelectedItem().toString().equals("Select Table Type")){
        ...
        String tReason =jTextArea2.getText();
          ...
          if("Hostel Table".equals(itemType)){
        try {
            ...
            Statement stmt = c.getConnectiondb().createStatement();
                ...
                for (int i=0; i < arrSplit.length; i++){
                     String selectQuery="SELECT itemid FROM hosteltable WHERE itemid='"+arrSplit[i]+"'";
                     ResultSet rs55 = stmt.executeQuery(selectQuery);
            
                    if(rs55.next()){
                  
                  String query = "SELECT * FROM hosteltabletransfer WHERE itemid = '"+arrSplit[i]+"'";
                  ResultSet rs1 = stmt.executeQuery(query);
                    if(rs1.next()){
                 
                   String query2= "UPDATE hosteltabletransfer,staffbed SET hosteltabletransfer.transferfrom='"+tFrom+"' , hosteltabletransfer.transferto='"+tTo+"',hosteltabletransfer.transferdate='"+tDate+"',hosteltabletransfer.transferreason='"+tReason+"' ,hosteltable.place='"+tTo+"'  WHERE hosteltabletransfer.itemid ='"+arrSplit[i]+"' and hosteltable.itemid=hosteltabletransfer.itemid";
                        int n1= stmt.executeUpdate(query2);
                                if(n1!=0){
                                    String query4="select systembalance from totalinventory where itemtype='Hostel Table' and place='"+tFrom+"'";
                                    ResultSet rs4=stmt.executeQuery(query4);
                                    if(rs4.next()){
                                        String fromCount=rs4.getString("systembalance");
                                        int fc=Integer.parseInt(fromCount);
                                        
                                        String query5="select systembalance from totalinventory where itemtype='Hostel Table' and place='"+tTo+"'";
                                        ...
                                        if(rs5.next()){
                                            ...
                                            tc=tc+1;
                                            String query6= "UPDATE totalinventory SET systembalance='"+fc+"' where itemtype='Hostel Table' and place='"+tFrom+"'";
                                            String query7= "UPDATE totalinventory SET systembalance='"+tc+"' where itemtype='Hostel Table' and place='"+tTo+"'";
                                           ...
                                           String query9 = "INSERT INTO totalinventory (itemtype,place,systembalance) VALUES ('Hostel Table','"+tTo+"','1')"; 
                                           String query10= "UPDATE totalinventory SET systembalance='"+fc+"' where itemtype='Hostel Table' and place='"+tFrom+"'";
                        ...
                        String query1 = "INSERT INTO hosteltabletransfer (itemid,transferfrom,transferto,transferdate,transferreason) VALUES ('"+arrSplit[i]+"','"+tFrom+"', '"+tTo+"','"+tDate+"','"+tReason+"')";
                        int n2 = stmt.executeUpdate(query1);
                        if(n2!=0){
                            String query3="UPDATE hosteltable SET place='"+tTo+"' where itemid ='"+arrSplit[i]+"'";
                            int n3 = stmt.executeUpdate(query3);
                                if(n3!=0){
                                    String query9="select systembalance from totalinventory where itemtype='Hostel Table' and place='"+tFrom+"'";
                                    ...
                                    if(rs9.next()){
                                        ...
                                        String query10="select systembalance from totalinventory where itemtype='Hostel Table' and place='"+tTo+"'";
          ...
          else   if("Staff Table".equals(itemType)){
        try {
            connectiondb c = new connectiondb();
            Statement stmt = c.getConnectiondb().createStatement();
                ...
                String arrSplit[] = itemId.split(","); 
                for (int i=0; i < arrSplit.length; i++){
                     String selectQuery="SELECT itemid FROM stafftable WHERE itemid='"+arrSplit[i]+"'";
                     ResultSet rs55 = stmt.executeQuery(selectQuery);
            
                    if(rs55.next()){
                  
                  String query = "SELECT * FROM stafftabletransfer WHERE itemid = '"+arrSplit[i]+"'";
                  ResultSet rs1 = stmt.executeQuery(query);
                    if(rs1.next()){
                 
                   String query2= "UPDATE stafftabletransfer,stafftable SET stafftabletransfer.transferfrom='"+tFrom+"' , stafftabletransfer.transferto='"+tTo+"',stafftabletransfer.transferdate='"+tDate+"',stafftabletransfer.transferreason='"+tReason+"' ,stafftable.place='"+tTo+"'  WHERE stafftabletransfer.itemid ='"+arrSplit[i]+"' and stafftable.itemid=stafftabletransfer.itemid";
                        int n1= stmt.executeUpdate(query2);
                                if(n1!=0){
                                    String query4="select systembalance from totalinventory where itemtype='Staff Table' and place='"+tFrom+"'";
                                    ResultSet rs4=stmt.executeQuery(query4);
                                    if(rs4.next()){
                                        String fromCount=rs4.getString("systembalance");
                                        int fc=Integer.parseInt(fromCount);
                                        
                                        String query5="select systembalance from totalinventory where itemtype='Staff Table' and place='"+tTo+"'";
                                        ResultSet rs5=stmt.executeQuery(query5);
                                         fc=fc-1;
                                        ...
                                        if(rs5.next()){
                                            ...
                                            int tc=Integer.parseInt(toCount);
                                            tc=tc+1;
                                            String query6= "UPDATE totalinventory SET systembalance='"+fc+"' where itemtype='Staff Table' and place='"+tFrom+"'";
                                            String query7= "UPDATE totalinventory SET systembalance='"+tc+"' where itemtype='Staff Table' and place='"+tTo+"'";
                                            int n6= stmt.executeUpdate(query6);
                                            int n7= stmt.executeUpdate(query7);
                                            if(n6!=0 && n7!=0){
                                                JOptionPane.showMessageDialog(rootPane,"Item update succefully 1");
                        ...
                        String query1 = "INSERT INTO stafftabletransfer (itemid,transferfrom,transferto,transferdate,transferreason) VALUES ('"+arrSplit[i]+"','"+tFrom+"', '"+tTo+"','"+tDate+"','"+tReason+"')";
                        int n2 = stmt.executeUpdate(query1);
                        if(n2!=0){
                            String query3="UPDATE stafftable SET place='"+tTo+"' where itemid ='"+arrSplit[i]+"'";
                            int n3 = stmt.executeUpdate(query3);
                                if(n3!=0){
                                    String query9="select systembalance from totalinventory where itemtype='Staff Table' and place='"+tFrom+"'";
                                    ResultSet rs9=stmt.executeQuery(query9);
                                    ...
                                    if(rs9.next()){
                                        ...
                                        String query10="select systembalance from totalinventory where itemtype='Staff Table' and place='"+tTo+"'";
                                        ResultSet rs10=stmt.executeQuery(query10);
                                        if(rs10.next()){
          ...
          //
         else if("Reading Table".equals(itemType)){
        try {
            connectiondb c = new connectiondb();
            Statement stmt = c.getConnectiondb().createStatement();
                ...
                String arrSplit[] = itemId.split(","); 
                for (int i=0; i < arrSplit.length; i++){
                     String selectQuery="SELECT itemid FROM readingtable WHERE itemid='"+arrSplit[i]+"'";
                     ResultSet rs55 = stmt.executeQuery(selectQuery);
            
                    if(rs55.next()){
                  
                  String query = "SELECT * FROM readingtabletransfer WHERE itemid = '"+arrSplit[i]+"'";
                  ResultSet rs1 = stmt.executeQuery(query);
                    if(rs1.next()){
                 
                   String query2= "UPDATE readingtabletransfer,readingtable SET readingtabletransfer.transferfrom='"+tFrom+"' , readingtabletransfer.transferto='"+tTo+"',readingtabletransfer.transferdate='"+tDate+"',readingtabletransfer.transferreason='"+tReason+"' ,readingtable.place='"+tTo+"'  WHERE readingtabletransfer.itemid ='"+arrSplit[i]+"' and readingtable.itemid=readingtabletransfer.itemid";
                        int n1= stmt.executeUpdate(query2);
                                if(n1!=0){
                                    String query4="select systembalance from totalinventory where itemtype='Reading Table' and place='"+tFrom+"'";
                                    ResultSet rs4=stmt.executeQuery(query4);
                                    if(rs4.next()){
                                        String fromCount=rs4.getString("systembalance");
                                        int fc=Integer.parseInt(fromCount);
                                        
                                        String query5="select systembalance from totalinventory where itemtype='Reading Table' and place='"+tTo+"'";
                                        ResultSet rs5=stmt.executeQuery(query5);
                                         fc=fc-1;
                                        ...
                                        if(rs5.next()){
                                            ...
                                            int tc=Integer.parseInt(toCount);
                                            tc=tc+1;
                                            String query6= "UPDATE totalinventory SET systembalance='"+fc+"' where itemtype='Reading Table' and place='"+tFrom+"'";
                                            String query7= "UPDATE totalinventory SET systembalance='"+tc+"' where itemtype='Reading Table' and place='"+tTo+"'";
                                            int n6= stmt.executeUpdate(query6);
                                            int n7= stmt.executeUpdate(query7);
                                            if(n6!=0 && n7!=0){
                                                JOptionPane.showMessageDialog(rootPane,"Item update succefully 1");
                                           ...
                                           String query9 = "INSERT INTO totalinventory (itemtype,place,systembalance) VALUES ('Reading Table','"+tTo+"','1')"; 
                                           String query10= "UPDATE totalinventory SET systembalance='"+fc+"' where itemtype='Reading Table' and place='"+tFrom+"'";
                                           int n9= stmt.executeUpdate(query9);
                                            int n10= stmt.executeUpdate(query10);
                                            if(n9!=0 && n10!=0){
                                                JOptionPane.showMessageDialog(rootPane,"Item update succefully 2");
                        ...
                        String query1 = "INSERT INTO readingtabletransfer (itemid,transferfrom,transferto,transferdate,transferreason) VALUES ('"+arrSplit[i]+"','"+tFrom+"', '"+tTo+"','"+tDate+"','"+tReason+"')";
                        int n2 = stmt.executeUpdate(query1);
                        if(n2!=0){
                            String query3="UPDATE readingtable SET place='"+tTo+"' where itemid ='"+arrSplit[i]+"'";
                            int n3 = stmt.executeUpdate(query3);
                                if(n3!=0){
                                    String query9="select systembalance from totalinventory where itemtype='Reading Table' and place='"+tFrom+"'";
                                    ResultSet rs9=stmt.executeQuery(query9);
                                    ...
                                    if(rs9.next()){
                                        ...
                                        String query10="select systembalance from totalinventory where itemtype='Reading Table' and place='"+tTo+"'";
                                        ResultSet rs10=stmt.executeQuery(query10);
                                        if(rs10.next()){
        ...
        ///
          if("Dinning Table".equals(itemType)){
        try {
            connectiondb c = new connectiondb();
            Statement stmt = c.getConnectiondb().createStatement();
                ...
                String arrSplit[] = itemId.split(","); 
                for (int i=0; i < arrSplit.length; i++){
                     String selectQuery="SELECT itemid FROM dinningtable WHERE itemid='"+arrSplit[i]+"'";
                     ResultSet rs55 = stmt.executeQuery(selectQuery);
            
                    if(rs55.next()){
                  
                  String query = "SELECT * FROM dinningtabletransfer WHERE itemid = '"+arrSplit[i]+"'";
                  ResultSet rs1 = stmt.executeQuery(query);
                    if(rs1.next()){
                 
                   String query2= "UPDATE dinningtabletransfer,dinningtable SET dinningtabletransfer.transferfrom='"+tFrom+"' ,dinningtabletransfer.transferto='"+tTo+"',dinningtabletransfer.transferdate='"+tDate+"',dinningtabletransfer.transferreason='"+tReason+"' ,dinningtable.place='"+tTo+"'  WHERE dinningtabletransfer.itemid ='"+arrSplit[i]+"' and dinningtable.itemid=dinningtabletransfer.itemid";
                        int n1= stmt.executeUpdate(query2);
                                if(n1!=0){
                                    String query4="select systembalance from totalinventory where itemtype='Dinning Table' and place='"+tFrom+"'";
                                    ResultSet rs4=stmt.executeQuery(query4);
                                    if(rs4.next()){
                                        String fromCount=rs4.getString("systembalance");
                                        int fc=Integer.parseInt(fromCount);
                                        
                                        String query5="select systembalance from totalinventory where itemtype='Dinning Table' and place='"+tTo+"'";
                                        ResultSet rs5=stmt.executeQuery(query5);
                                         fc=fc-1;
                                        ...
                                        if(rs5.next()){
                                            ...
                                            int tc=Integer.parseInt(toCount);
                                            tc=tc+1;
                                            String query6= "UPDATE totalinventory SET systembalance='"+fc+"' where itemtype='Dinning Table' and place='"+tFrom+"'";
                                            String query7= "UPDATE totalinventory SET systembalance='"+tc+"' where itemtype='Dinning Table' and place='"+tTo+"'";
                                            int n6= stmt.executeUpdate(query6);
                                            int n7= stmt.executeUpdate(query7);
                                            if(n6!=0 && n7!=0){
                                                JOptionPane.showMessageDialog(rootPane,"Item update succefully 1");
                                           ...
                                           String query9 = "INSERT INTO totalinventory (itemtype,place,systembalance) VALUES ('Dinning Table','"+tTo+"','1')"; 
                                           String query10= "UPDATE totalinventory SET systembalance='"+fc+"' where itemtype='Dinning Table' and place='"+tFrom+"'";
                                           int n9= stmt.executeUpdate(query9);
                                            int n10= stmt.executeUpdate(query10);
                                            if(n9!=0 && n10!=0){
                                                JOptionPane.showMessageDialog(rootPane,"Item update succefully 2");
                        ...
                        String query1 = "INSERT INTO dinningtabletransfer (itemid,transferfrom,transferto,transferdate,transferreason) VALUES ('"+arrSplit[i]+"','"+tFrom+"', '"+tTo+"','"+tDate+"','"+tReason+"')";
                        int n2 = stmt.executeUpdate(query1);
                        if(n2!=0){
                            String query3="UPDATE dinningtable SET place='"+tTo+"' where itemid ='"+arrSplit[i]+"'";
                            int n3 = stmt.executeUpdate(query3);
                                if(n3!=0){
                                    String query9="select systembalance from totalinventory where itemtype='Dinning Table' and place='"+tFrom+"'";
                                    ResultSet rs9=stmt.executeQuery(query9);
                                    ...
                                    if(rs9.next()){
                                        ...
                                        String query10="select systembalance from totalinventory where itemtype='Dinning Table' and place='"+tTo+"'";
                                        ResultSet rs10=stmt.executeQuery(query10);
                                        if(rs10.next()){
        ...
        ///
        else if("Exam Table".equals(itemType)){
        try {
            connectiondb c = new connectiondb();
            Statement stmt = c.getConnectiondb().createStatement();
                ...
                String arrSplit[] = itemId.split(","); 
                for (int i=0; i < arrSplit.length; i++){
                     String selectQuery="SELECT itemid FROM examtable WHERE itemid='"+arrSplit[i]+"'";
                     ResultSet rs55 = stmt.executeQuery(selectQuery);
            
                    if(rs55.next()){
                  
                  String query = "SELECT * FROM examtabletransfer WHERE itemid = '"+arrSplit[i]+"'";
                  ResultSet rs1 = stmt.executeQuery(query);
                    if(rs1.next()){
                 
                   String query2= "UPDATE examtablestaffbedtransfer,examtable SET examtabletransfer.transferfrom='"+tFrom+"' ,examtabletransfer.transferto='"+tTo+"',examtabletransfer.transferdate='"+tDate+"',examtabletransfer.transferreason='"+tReason+"' ,examtable.place='"+tTo+"'  WHERE examtabletransfer.itemid ='"+arrSplit[i]+"' and examtable.itemid=examtabletransfer.itemid";
                        int n1= stmt.executeUpdate(query2);
                                if(n1!=0){
                                    String query4="select systembalance from totalinventory where itemtype='Exam Table' and place='"+tFrom+"'";
                                    ResultSet rs4=stmt.executeQuery(query4);
                                    if(rs4.next()){
                                        String fromCount=rs4.getString("systembalance");
                                        int fc=Integer.parseInt(fromCount);
                                        
                                        String query5="select systembalance from totalinventory where itemtype='Exam Table' and place='"+tTo+"'";
                                        ResultSet rs5=stmt.executeQuery(query5);
                                         fc=fc-1;
                                        ...
                                        if(rs5.next()){
                                            ...
                                            int tc=Integer.parseInt(toCount);
                                            tc=tc+1;
                                            String query6= "UPDATE totalinventory SET systembalance='"+fc+"' where itemtype='Exam Table' and place='"+tFrom+"'";
                                            String query7= "UPDATE totalinventory SET systembalance='"+tc+"' where itemtype='Exam Table' and place='"+tTo+"'";
                                            int n6= stmt.executeUpdate(query6);
                                            int n7= stmt.executeUpdate(query7);
                                            if(n6!=0 && n7!=0){
                                                JOptionPane.showMessageDialog(rootPane,"Item update succefully 1");
                                           ...
                                           String query9 = "INSERT INTO totalinventory (itemtype,place,systembalance) VALUES ('Exam Table','"+tTo+"','1')"; 
                                           String query10= "UPDATE totalinventory SET systembalance='"+fc+"' where itemtype='Exam Table' and place='"+tFrom+"'";
                                           int n9= stmt.executeUpdate(query9);
                                            int n10= stmt.executeUpdate(query10);
                                            if(n9!=0 && n10!=0){
                                                JOptionPane.showMessageDialog(rootPane,"Item update succefully 2");
                        ...
                        String query1 = "INSERT INTO examtabletransfer (itemid,transferfrom,transferto,transferdate,transferreason) VALUES ('"+arrSplit[i]+"','"+tFrom+"', '"+tTo+"','"+tDate+"','"+tReason+"')";
                        int n2 = stmt.executeUpdate(query1);
                        if(n2!=0){
                            String query3="UPDATE examtable SET place='"+tTo+"' where itemid ='"+arrSplit[i]+"'";
                            int n3 = stmt.executeUpdate(query3);
                                if(n3!=0){
                                    String query9="select systembalance from totalinventory where itemtype='Exam Table' and place='"+tFrom+"'";
                                    ResultSet rs9=stmt.executeQuery(query9);
                                    ...
                                    if(rs9.next()){
                                        ...
                                        String query10="select systembalance from totalinventory where itemtype='Exam Table' and place='"+tTo+"'";
                                        ResultSet rs10=stmt.executeQuery(query10);
                                        if(rs10.next()){
    ...
    private void jTextArea1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextArea1KeyTyped
        String PATTERN= "^[A-Za-z0-9/,]{0,30000}$";
        Pattern patt=Pattern.compile(PATTERN);
        Matcher match=patt.matcher(jTextArea1.getText());
        if(!match.matches()){
            jLabel17.setText("Please use valid ID as UWU/FF/01 and use comma for seperate the Item Id!");
        }else{
...
//        jPanelmangement.setVisible(true);
    ...
    private void jTextField1KeyTyped2(java.awt.event.KeyEvent evt) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventoryTransferTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
