 ...
 * @author Piyumi
 */
public class SearchItemType extends javax.swing.JFrame {
...
DefaultTableModel model;
     ...
     public void addTableHeader(){
        ...
        Object[] newIdetifiers=new Object[]{"Item Type","Item Id","Place","Remark","Last Updated Date"};
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/table5.jpg"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel2.setText("Item Type");

        jLabel1.setFont(new java.awt.Font("Cambria", 1, 22)); // NOI18N
        jLabel1.setText("Search Item Type");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jComboBox1.getSelectedItem().toString().equals("Select Item Type")){
            JOptionPane.showMessageDialog(rootPane,"Select Item Type" );
        }
         else{
        model.addRow(new Object[]{"Item Type","Item Id","Place","Remark","Last Updated Date"});
        ...
        try{
            ...
            if(itemtype=="Staff Bed" ){
                String query1 = "SELECT * FROM staffbed";
                ...
                while(rs1.next()){
                    ...
                    String lastupdateddate = rs1.getString("lastupdateddate");
            ...
            //
                ...
                String query2 = "SELECT * FROM studentbed";
                ...
                while(rs2.next()){
                    ...
                    String lastupdateddate = rs2.getString("lastupdateddate");
            ...
            //
                ...
                String query2 = "SELECT * FROM hostelchair";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM staffchair";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM readingchair";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM dinningchair";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM canteenchair";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM  hosteltable";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM stafftable";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM readingtable";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM dinningtable";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM examtable";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
            else if(itemtype=="News Paper Holder" ){

                String query2 = "SELECT * FROM newspaperholder";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM towelrack";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM almari";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM hostelcupboard";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM  dressingtable";
                ResultSet rs2 = stmt.executeQuery(query2);
            ...
            //
                ...
                String query2 = "SELECT * FROM dressingtablestool";
                ResultSet rs2 = stmt.executeQuery(query2);
 ...
 public void excelGenerator(){    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchItemType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchItemType().setVisible(true);
            }
        });
    }
