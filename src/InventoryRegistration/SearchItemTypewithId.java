 ...
 * @author Piyumi
 */
public class SearchItemTypewithId extends javax.swing.JFrame {

    /**
     * Creates new form ChairRegistration
     */
    public SearchItemTypewithId() {
        initComponents();
   ...
   DefaultTableModel model;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if(itemtype=="Staff Bed" ){
                String query1 = "SELECT * FROM staffbed WHERE itemid = '"+itemid+"'  ";
                ...
                while(rs.next()){
                    ...
                    model.addRow(new Object[]{itemtype,itemid,place,remark,lastupdateddate});
                }
            }
            //
            else if(itemtype=="Student Bed" ){
                String query1 = "SELECT * FROM studentbed WHERE itemid = '"+itemid+"'   ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM hostelchair WHERE itemid = '"+itemid+"'   ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM staffchair WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM readingchair WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM dinningchair WHERE itemid = '"+itemid+"' ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM canteenchair WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM hosteltable WHERE itemid = '"+itemid+"' ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM stafftable WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM readingtable WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM dinningtable WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM examtable WHERE itemid = '"+itemid+"' ";
                ResultSet rs = stmt.executeQuery(query1);
            ...
            if(itemtype=="News Paper Holder" ){
                String query1 = "SELECT * FROM newspaperholder WHERE itemid = '"+itemid+"' ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM towelrack WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM almari WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM hostelcupboard WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM dressingtable WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
                ...
                String query1 = "SELECT * FROM dressingtablestool WHERE itemid = '"+itemid+"'  ";
                ResultSet rs = stmt.executeQuery(query1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchItemTypewithId.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchItemTypewithId().setVisible(true);
            }
        });
    }
