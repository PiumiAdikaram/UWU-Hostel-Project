...
import TransferManagement.*;
import TransferManagement.SelectTransferInventory;
 ...
 * @author Piyumi
 */
public class UpdateHostel extends javax.swing.JFrame {

    /**
     * Creates new form newplaceregistration
     */
    public UpdateHostel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/FB_IMG_1465264550993.jpg"))); // NOI18N

        jLabel7.setFont(new java.awt.Font("Cambria", 1, 22)); // NOI18N
        jLabel7.setText("Update Hostel Details");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Hostel Name" }));

        jComboBox1.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Student Year", "Year 1", "Year 2", "Year 3", "Year 4" }));
...
/*        Login l = new Login();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String hostelname = jComboBox2.getSelectedItem().toString();
        String year = jComboBox1.getSelectedItem().toString();

        if(jComboBox2.getSelectedItem().toString().equals("Select Hostel Name")){
            ...
            String query4 = "UPDATE hostel SET year = '"+year+"' WHERE hostelname = '"+hostelname+"' ";
             int n1=0;
                    n1=stmt.executeUpdate(query4);
                        if(n1!=0){
                            JOptionPane.showMessageDialog(rootPane, "Hostel Updated Successfully"); 
                        }   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateHostel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
