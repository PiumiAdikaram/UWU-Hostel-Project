 ...
 * @author Piyumi
 */
public class ViewItemSystembalance extends javax.swing.JFrame {

    /**
     * Creates new form ViewItemSystembalance
     */
    public ViewItemSystembalance() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Display Inventory System Balance");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/FB_IMG_1456239931618.jpg"))); // NOI18N
    ...
    public void addTableHeader(){
        ...
        Object[] newIdetifiers=new Object[]{ "Item Type","Place", "Syste Balansce"};
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String query1 = "SELECT * FROM totalinventory WHERE place = '"+hostelname+"' && itemtype= '"+itemType+"'  ";
            ...
            while(rs.next()){
                ...
                int systembalance = rs.getInt("systembalance");

              
                model.addRow(new Object[]{itemtype,place,systembalance});
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewItemSystembalance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
